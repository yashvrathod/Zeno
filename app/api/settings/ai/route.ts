...
export async function GET() {
  try {
    ...
    return Response.json({
      ...
      preferredFreeModel: settings?.preferredFreeModel || 'deepseek/deepseek-chat-v3-0324:free',
  ...
  try {
    ...
    const updated = await prisma.userAiSettings.upsert({
      ...
      create: {
        ...
        preferredFreeModel: preferredFreeModel || 'deepseek/deepseek-chat-v3-0324:free',
      ...
      update: {
        ...
        ...(preferredFreeModel !== undefined && { preferredFreeModel: preferredFreeModel || 'deepseek/deepseek-chat-v3-0324:free' }),
