...
export const DYNAMIC_LANGUAGES: readonly Language[] = ["javascript", "python"] as const;
export const COMPILED_LANGUAGES: readonly Language[] = ["java", "cpp"] as const;

export function isDynamicLanguage(lang: string): lang is "javascript" | "python" {
  return lang === "javascript" || lang === "python";
}

export function isSupportedLanguage(lang: string): lang is Language {
  return lang === "javascript" || lang === "python" || lang === "java" || lang === "cpp";
}
